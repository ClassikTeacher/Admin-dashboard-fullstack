...
interface SelectProps{
    ...
    defaultValue: string
    changeValue: Dispatch<SetStateAction<string>> | Dispatch<SetStateAction<number>> 
}

const MySelect: FC<SelectProps> = ({nameInput, defaultValue, options, changeValue, valueSelect})=>{
...
return(
    <div className={styles.selectContainer}>
      <label htmlFor={`form${nameInput}`} className={styles.feedback__label}>{nameInput}</label>
    <select
